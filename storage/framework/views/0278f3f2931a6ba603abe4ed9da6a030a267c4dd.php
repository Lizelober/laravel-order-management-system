...
unset($__errorArgs, $__bag); ?>
                        ...
                        ?>
                        <div class="row mb-3">
                            <label for="currency_countries_id" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Country')); ?></label>
                            <div class="col-md-6">
                                <select id="currency_countries_id" name="currency_countries.id" class="form-select">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-order-management-system\resources\views/auth/register.blade.php ENDPATH**/ ?>