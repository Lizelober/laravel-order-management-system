                ...
                <div class="dropdown">
                    <div class="dropdown-menu">
                        <div class="row total-header-section">
                            @php $total = 0 @endphp
                            @foreach((array) session('cartItems') as $id => $values)
                        ...
                        <div class="row cart-detail">
                            ...
                            <div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
                                ...
                                <span class="price text-info"> {{ $values['currency_sign'] }} {{ $values['Price'] * $values['exchange_rate']  }}</span> <span class="count">Quantity:{{ $values['quantity'] }}</span>
                            </div>
                        </div>
                        @endforeach
                        @endif
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                                <a href="{{ route('carts.index') }}" class="btn btn-primary btn-block">View all</a>
                            </div>
                        </div>
                    </div>
                </div>
